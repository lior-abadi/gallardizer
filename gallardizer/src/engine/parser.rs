...
pub fn expression_as_target(expression: &pt::Expression) -> Target {
    match expression {
        ...
        pt::Expression::NumberLiteral(..) => Target::NumberLiteral,
        pt::Expression::RationalNumberLiteral(..) => Target::RationalNumberLiteral,
        pt::Expression::HexNumberLiteral(..) => Target::HexNumberLiteral,
